...
\textit{Reverse sensitivity of Southern Ocean transport to changes in wind forcing}
...
\item[*] \textbf{J. Mak}$^{\dagger}$, N. Harnik, E. Heifetz, \textbf{G. Kumar}$^{\dagger}$, \textbf{E. C. Y. Ong} \& L. Yeow (submitted to Phys. Rev. Fluids)\\
\textit{Edge-wave phase-shifts versus normal-mode phase-tilts in an Eady problem}
