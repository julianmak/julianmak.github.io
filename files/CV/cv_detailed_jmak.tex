...
\item \textbf{Tenure-track faculty}\\
Hong Kong University of Science and Technology\\
-- Associate professor (Jul 2025 -- date)\\
-- Assistant professor (Jul 2019 -- Jun 2025)\\
-- Department of Ocean Science (Jul 2019 -- date)\\
-- Department of Mathematics (Sep 2026 -- date)

\item \textbf{NOC associate} (visiting position; Sep 2023 -- to date)\\
National Oceanography Centre, UK

\item \textbf{Post-doctoral researcher} (Oct 2017 -- May 2019)\\
AOPP, Department of Physics, University of Oxford\\
-- working with David P. Marshall (PI) and James R. Maddison (Co-I) 
...
%\item[*] X. Su, R. Chen$^{\S}$, \textbf{J. Mak}, Z. Zhang, Q. Geng \& A. L. Stewart (submitted to JPO)\\
%A description of spatially local and nonlocal potential energy cascade in the global ocean

\item[*] \textbf{H. S. Lee}$^{\S}$, R. Chen, \textbf{J. Mak}$^{\S}$, D. P. Marshall \& Y. Wang (in prep.)\\
\textit{Intrinsic oscillatory time-scales in an energy constrained eddy parameterization}

\item[*] \textbf{F. O. Sudre}$^{\S}$, M. L\'evy, \textbf{J. Mak}$^{\S}$ \& \textbf{X. Ruan} (in prep.)\\
\textit{Modeled biogeochemical variability in an eddy-permitting model with eddy parameterization}

\item[*] \textbf{J. Yin}$^{\S}$, N. Harnik, E. Heifetz \& \textbf{J. Mak}$^{\S}$ (in prep.)\\
\textit{Transient growth and Counter-propagating Rossby Waves in a sloped Eady problem}

\item[*] \textbf{X. Ruan}$^{\S}$, S. Dol\'eac$^{\S}$, L. Bopp, \textbf{J. Mak}, F. U. Schwarzkopf, A. Biastoch \& M. L\'evy (submitted to Biogeosci.)\\
\textit{Physical controls on North Atlantic organic carbon export from eddying ocean models}

\item[30.] T. Zheng, R. Chen$^{\S}$, X. Su, \textbf{J. Mak}, G. Huang \& B. Yan (2026)\\
Climate-adaptive and cascade-constrained machine learning prediction for sea surface height under greenhouse warming\\
J. Adv. Model. Earth Syst., \textbf{18}(7), e2025MS005717

\item[29.] R. Torres$^{\S}$, R. Waldman, G. Madec, C. de Lavergne, R. S\'ef\'erian \& \textbf{J. Mak} (2025)\\
\textit{An energetically and observationally constrained mesoscale parameterization for ocean climate models}\\
J. Adv. Model. Earth Syst., \textbf{17}(12), e2025MS005394
...
\item[--] \textit{Implementation and evaluation of the scale-awareness GEOMETRIC scheme for multi-resolution coupled model}\\
1st Apr 2026 --- 31st Mar 2027 (PI w/ Hajoon Song, Yonsei University)\\
HKD 40,000 + KRW 7,000,000 (travel grants), 12 months\\
2026 HKUST-YONSEI Global Knowledge Network Awards

\item[--] \textit{Modelling the Ocean's Breath: Improving Mesoscale Representation for Biogeochemical Cycles}\\
1st Apr 2026 --- 31st Mar 2029 (PI w/ Marina L\'evy, LOCEAN-IPSL)\\
HKD 2,638,451 (exclusive of overheads) + EUR 202,673, 36 months\\
ANR/RGC Joint Research Scheme (A-HKUST604/25)

\item[--] \textit{Developing a novel framework for understanding ocean biogeochemical change}\\
1st Jan 2026 --- 31st Dec 2027 (PI w/ Graeme MacGilchrist, St. Andrews)\\
HKD 40,000 + GBP 4,750 (travel grants), 12 months\\
...
1st Apr 2025 --- 31st Mar 2027 (PI; RIAM host: Yusuke Kosuga and Yohei Onuki)\\
JPY 200,000 $\times 2$ (travel grant), 24 months\\
RIAM international joint research (2025S2-CD-5, 2026S2-CD-7)
...
\item[--] \textit{Modelling (multi-)decadal eddy-driven Southern Ocean variability}\\
RIAM seminar, Kyushu University, Fukuoka, Japan, Jun 2026

\item[--] \textit{Modelling (multi-)decadal eddy-driven Southern Ocean variability}\\
JpGU, Chiba, Japan, May 2026

\item[--] \textit{Modelling of Southern Ocean decadal variability arising from eddy-mean interactions}\\
(Invited keynote) Eddy-wave meeting, TRR 181, Hamburg (remote attendance), Apr 2026

\item[--] \textit{Summary of eddy parameterisations in the NEMO model}\\
(Invited plenary) LEAP-HCS opening workshop, Paris (remote attendance), Feb 2026
...
\item[--] Scientific committee: LEAP-HCS (Oct 25 to Sep 29; PI: Said Ouala)

\item[--] Editor: EGU Ocean Sci. (Aug 24 onwards; outstanding editor 2025)

\item[--] Reviewer for: NSF; ANR; J. Fluid Mech.; Phys. Fluids; Phys. Lett. A; J. Phys. Oceanogr.; Phys. Plasmas; Astrophys. J.; J. Geophys. Res: Oceans; Ocean Modell.; J. Adv. Model. Earth Syst.; IPCC AR6 WG1 (second draft); EGU Ocean Sci.; Geophys. Res. Lett.

\item[--] NEMO (Nucleus for European Modelling of the Ocean) working group on eddy parameterisations (22/23 onwards, co-chair from Apr 25); NEMO developer under the NERC consortium (23/24 onwards)

\item[--] (Dept. of Ocean Science, HKUST) Merit and Salary Review Committee (25/26 to date), Search and Appointment Committee (25/26 to date), Substantial and Promotion Committee (25/26 to date), Discovering Ocean Science summer school (22/23, 23/24), Departmental seminar organiser (20/21 to 23/24), International Research Enrichment track co-ordinator (20/21 to date), MSc committee (21/22), UG committee (20/21 to date; co-chair 22/23), Teaching Faculty appointment and promotion committee (22/23 to date; chair 25/26 to date), Student Mentoring Task Force (19/20 to 22/23), physical oceanography group meeting oragniser (20/21 to date)
...
\begin{tabularx}{\textwidth}{XXX}
  Tim DU                  & PhD   & Sep 2026 -- now\\
  Ryan CHAN               & MPhil & Sep 2026 -- now\\
...
\begin{tabularx}{\textwidth}{XXX}
  XU Yanjun               & BSc (Capstone; exchange) & Feb 2026 -- now\\
...
\begin{itemize}
  \item[26/27:] Data Analysis in Ocean Science (3rd year, I, 40), AI and Machine Learning for Ocean Science (4th year, I, 10), Machine Learning for Ocean Science (PGs, I, 20)
