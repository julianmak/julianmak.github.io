...
\item[*] \textbf{H. S. Lee}$^{\S}$, R. Chen, J. R. Maddison, \textbf{J. Mak}$^{\S}$, D. P. Marshall \& Y. Wang (in prep.)\\
...
\item[*] \textbf{X. Ruan}$^{\S}$, S. Dol\'eac$^{\S}$, L. Bopp, \textbf{J. Mak} F. U. Schwarzkopf, A. Biastoch \& M. L\'evy (in prep.)\\
