...
\item[*] \textbf{J. Mak}$^{\dagger}$, N. Harnik, E. Heifetz, \textbf{G. Kumar}$^{\dagger}$, \textbf{E. C. Y. Ong} \& L. Yeow (in prep. for Phys. Rev. Fluids)\\
\textit{Instability characteristics of the modified geostrophic Eady problem revisited}
...
\item[*] \textbf{X. Ruan}$^{\dagger}$, D. Couespel, M. L\'evy, \textbf{J. Mak}$^{\dagger}$ \& Y. Wang (in prep. for Ocean Modell.)\\
...
1st Jul 2021 --- ongoing (Co-I, then PI)\\
...
1st Jul 2021 --- ongoing (PI, Co-I: Matt Mazloff)\\
