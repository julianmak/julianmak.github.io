...
\item[*] R. Torres$^{\dagger}$, R. Waldman, \textbf{J. Mak}, \& R. S\'ef\'erian (in prep. for Geophys. Res. Lett.)\\
\textit{Global estimate of eddy kinetic energy dissipation from a diagnostic energy balance}

\item[*] \textbf{J. Mak}$^{\dagger}$, J. R. Maddison, D. P. Marshall, \textbf{X. Ruan}, Y. Wang \& L. Yeow (in prep. for J. Adv. Model. Earth Syst.)\\
\textit{A split field approach for regulating parameterization of oceanic mesoscale eddy effects}

\item[*] \textbf{F. E. Yan}$^{\dagger}$, J. R. Maddison, \textbf{J. Mak}$^{\dagger}$, Y. Wang \& L. Yeow (in prep. for J. Adv. Model. Earth Syst.)\\
\textit{Machine learning of baroclinic turbulence: the role of rotational fluxes}

%\item[*] \textbf{J. Mak}$^{\dagger}$, \textbf{E. Ong}, N. Harnik, D. G. Dritschel \& E. Heifetz (in prep.)\\ Mirial Sterl?
