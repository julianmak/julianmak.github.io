...
\item[*] E. Heifetz$^{\dagger}$, L. R. M. Maas \& \textbf{J. Mak} (in prep.)\\
\textit{On the equilvalence between electro-magnetic waves in cold plasmas and shallow water inertio-gravity waves}

\item[*] J. R. Maddison$^{\dagger}$, D. P. Marshall \& \textbf{J. Mak} (in prep.)\\
...
\item[10.] Y. Y. Cheung, S. Cheung$^{\dagger}$, \textbf{J. Mak}, K. Liu, X. Xia, X. Zhang, Y. Yung \& H. Liu$^{\dagger}$ (accepted)\\
