...
\item[*] \textbf{H. S. Lee}$^{\S}$ \textbf{J. Mak}$^{\S}$, D. P. Marshall \& Y. Wang (submitted to Tellus A)\\
\textit{Over-saturation of Southern Ocean circumpolar transport controlled by residual overturning}

\item[*] J. R. Maddison$^{\S}$, D. P. Marshall, \textbf{J. Mak} \& K. Maurer-Song (submitted to J. Adv. Model. Earth Syst.)\\
...
\begin{itemize}
  \item[24/25:] The Earth as a Blue Planet (1st year, Co-I, 70, both semesters),
  Descriptive Physical Oceanography (2nd year, I, 25), Data Analysis in Ocean
  Science (3rd/4th year, I, 5), Physical Oceanography (undergraduates, I, 5)
