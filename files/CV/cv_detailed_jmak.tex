...
\textit{Eddy over-saturation of Southern Ocean transport}
...
\item[*] \textbf{J. Mak}$^{\dagger}$, N. Harnik, E. Heifetz, \textbf{G. Kumar}$^{\dagger}$ \& \textbf{E. C. Y. Ong} (submitted to Phys. Rev. Fluids)\\
...
\item[--] (Dept. of Ocean Science, HKUST) co-UG co-ordinator (22/23),
Departmental seminar organiser (20/21 to date), International Research
Enrichment track co-ordinator (20/21 to date), MSc committee (21/22), UG
committee (20/21 to date), Teaching Faculty appointment and promotion committee
(22/23 to date), Student Mentoring Task Force (19/20 to 22/23), physical
oceanography group meeting oragniser (20/21 to date)
