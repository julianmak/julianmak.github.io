...
\item[*] \textbf{J. Mak}$^{\dagger}$, N. Harnik, E. Heifetz, \textbf{G. Kumar}, \textbf{E. C. Y. Ong} \& L. Yeow (in prep. for Phys. Rev. Fluids)\\
...
\item[*] \textbf{F. E. Yan}$^{\dagger}$, \textbf{J. Mak}$^{\dagger}$ \& Y. Wang (submitted to J. Adv. Model. Earth Syst.)\\
