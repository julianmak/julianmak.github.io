...
($\dagger$ denotes corresponding author, bold denotes members from group)

\begin{itemize}


\item[*] \textbf{F. E. Yan}$^{\dagger}$, \textbf{J. Mak} \& \textbf{Y. Na} (in prep. for J. Adv. Model. Earth Syst.)\\
\textit{Machine learning of baroclinic turbulence: the role of rotational fluxes}

\item[*] \textbf{X. Ruan}$^{\dagger}$, D. Couespel, M. L\'evy \& \textbf{J. Mak} (in prep. for Ocean Modell.)\\
\textit{Assessing the influence of mesoscale turbulence parameterizations on net primary production in ocean models}

\item[*] \textbf{J. Mak}$^{\dagger}$, A. Avdis, T. David, \textbf{H. S. Lee}, \textbf{Y. Na}, Y. Wang \& \textbf{F. E. Yan}
(in prep for J. Adv. Model. Earth Syst.)\\
...
Geophysical Research Letters, \textbf{49}, e2021GL097259
...
\item[--] \textit{Ocean mesoscale eddy redisdence time-scale and its control on the global overturning circulation}\\
...
track co-ordinator, MSc committee, UG committee, Teaching Faculty appointment
and promotion committee, Student Mentoring Task Force (Dept. of Ocean Science,
HKUST)
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}llr}
  Gautam KUMAR            & PDRA  & Baroclinic instability            & Mar 2021 -- now\\
  \\
  Dan BARTLEY             & MPhil & Boundary layer flows              & Sep 22 -- now\\
  YAN Feier               & PhD   & Machine learning                  & Feb 21 -- now\\
  NA Yongsu               & PhD   & State estimation                  & Sep 20 -- now\\
  RUAN Xi                 & PhD   & BGC focused ocean modelling       & Sep 20 -- now\\
  LIU Yongqi              & MPhil & Parameterisations                 & Sep 20 -- Aug 22\\
  LEE Han Seul            & PhD   & Dynamics based ocean modelling    & Sep 19 -- now\\
  \\
\end{tabular*}

\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}llr}
  Dan BARTLEY             & RA    &  & Feb 22 -- now\\
  Chinmayee MALLICK       & RA    &  & Apr 20 -- Mar 21\\
  Floriane Oc\'eane SUDRE & RA    &  & Mar 20 -- Aug 20\\
  \\
  DONG Zipei              & MSc               & Informaton entropy       & Sep 21 -- Dec 21\\
  JIANG Jinxiao           & MSc               & Machine learning methods & Sep 20 -- May 21\\
  Ellie ONG               & Visiting scholar  & Baroclinic lifecycles    & Oct 20 -- Jan 21\\
  RUAN Xi                 & MSc               & NPZ model                & Feb 20 -- Jul 20\\
  LEE Han Seul            & MPhys (at Oxford) &                          & Jan 17 -- Sep 17\\
  \\
  Matthew FONG            & BSc (UROP)      & PT symmetry in shear flows      & Feb 22 -- Jun 22\\
  Tim DU                  & BSc (FYP)       & Kalman filters                  & Sep 21 -- May 22\\
  Anastasia LEUNG         & BSc (UROP)      & Statistical mechanics models of & Jul 21 -- Sep 21\\
                          &                 & phase transitions               & \\
  Rachel TSOI             & BSc (FYP)       & Models of the Hadley cells      & Sep 20 -- May 21\\
  Jolie NG                & BSc (FYP)       & Models of El-Ni\~no             & Sep 20 -- May 21\\
  Nick KANG               & BSc (UROP)      & Chaotic mixing                  & Jul 20 -- Sep 20\\
  Haruki SAEGUSA          & BSc (UROP)      & Chaotic mixing                  & Jun 21 -- Jan 22\\
                          & BSc (UG helper) &                                 & Sep 20 -- Sep 20\\
  Kathryn CHOW            & BSc (Capstone)  & BGC models                      & Feb 20 -- Jul 20\\
\end{tabular*}
